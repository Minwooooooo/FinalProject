...
public class ChatTranslateService {
    ...
    public String translate(String message) {
        ...
        if (language.equals("en")) {
            ...
            String responseBody = postKoToEn(apiURL, requestHeaders, text);
            return responseBody;
        }else{
            return language;
        }
    ...
    private static String postKoToEn(String apiUrl, Map<String, String> requestHeaders, String text) {
    ...
    private static String postEnToKo(String apiUrl, Map<String, String> requestHeaders, String text) {
        HttpURLConnection con = connect(apiUrl);
    ...
    public static String languageSensing(String message, String clientId, String clientSecret) {
        ...
        String result = responseBody.substring(responseBody.lastIndexOf(":") + 2, responseBody.lastIndexOf(":") + 4);
